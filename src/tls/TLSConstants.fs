...
let ecCurveBytes ecb =
    match ecb with
    | ECC_P256 -> abyte2 (0uy, 23uy)
    | ECC_P384 -> abyte2 (0uy, 24uy)
    | ECC_P521 -> abyte2 (0uy, 25uy)

let parseEcCurve b =
    match cbyte2 b with
    | (0uy, 23uy) -> correct ECC_P256
    | (0uy, 24uy) -> correct ECC_P384
    | (0uy, 25uy) -> correct ECC_P521
    | _ -> Error(AD_decode_error, perror __SOURCE_FILE__ __LINE__ "")
...
let cipherSuiteBytes cs =
    ...
    | CipherSuite (ECDHE_ECDSA, CS_MtE (RC4_128, SHA))      -> abyte2 ( 0xc0uy, 0x02uy )
    | CipherSuite (ECDHE_ECDSA, CS_MtE (TDES_EDE_CBC, SHA)) -> abyte2 ( 0xc0uy, 0x03uy )
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA))  -> abyte2 ( 0xc0uy, 0x04uy )
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA256)) -> abyte2 ( 0xc0uy, 0x23uy )
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA))  -> abyte2 ( 0xc0uy, 0x05uy )
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA384)) -> abyte2 ( 0xc0uy, 0x24uy )
    | CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_128_GCM, SHA256)) -> abyte2 ( 0xc0uy, 0x2buy )
    | CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_256_GCM, SHA384)) -> abyte2 ( 0xc0uy, 0x2cuy )
...
let parseCipherSuite b =
    ...
    | ( 0xc0uy, 0x02uy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_MtE (RC4_128, SHA)))
    | ( 0xc0uy, 0x03uy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_MtE (TDES_EDE_CBC, SHA)))
    | ( 0xc0uy, 0x04uy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA)))
    | ( 0xc0uy, 0x05uy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA)))
    | ( 0xc0uy, 0x23uy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA256)))
    | ( 0xc0uy, 0x24uy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA384)))
    | ( 0xc0uy, 0x2buy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_128_GCM, SHA256)))
    | ( 0xc0uy, 0x2cuy ) -> correct(CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_256_GCM, SHA384)))
...
let sigAlg_of_ciphersuite cs =
    ...
    | CipherSuite(ECDHE_RSA,_)
#endif
    | CipherSuite( RSA, _ ) | OnlyMACCipherSuite( RSA, _ )
...
let cipherSuite_of_name (name:cipherSuiteName) =
    ...
    | TLS_ECDHE_ECDSA_WITH_RC4_128_SHA         -> CipherSuite (ECDHE_ECDSA, CS_MtE (RC4_128, SHA))
    | TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA    -> CipherSuite (ECDHE_ECDSA, CS_MtE (TDES_EDE_CBC, SHA))
    | TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA     -> CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA))
    | TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256  -> CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA256))
    | TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA     -> CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA))
    | TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384  -> CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA384))
    | TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256  -> CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_128_GCM, SHA256))
    | TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384  -> CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_256_GCM, SHA384))
...
let name_of_cipherSuite cs =
    ...
    | CipherSuite (ECDHE_ECDSA, CS_MtE (RC4_128, SHA))       ->  correct TLS_ECDHE_ECDSA_WITH_RC4_128_SHA
    | CipherSuite (ECDHE_ECDSA, CS_MtE (TDES_EDE_CBC, SHA))  ->  correct TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA))   ->  correct TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_128_CBC, SHA256)) -> correct TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA))   ->  correct TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA
    | CipherSuite (ECDHE_ECDSA, CS_MtE (AES_256_CBC, SHA384)) -> correct TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384
    | CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_128_GCM, SHA256)) -> correct TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256
    | CipherSuite (ECDHE_ECDSA, CS_AEAD(AES_256_GCM, SHA384)) -> correct TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384
